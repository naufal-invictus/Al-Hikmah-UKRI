      ...
      <div className="border-[8px] border-double border-[#D4AF37] h-full p-6 relative bg-[#FAF9F6]">
        ...
        <div className="text-center flex flex-col items-center justify-center h-full py-8 space-y-6">
            ...
            <div className="mb-2">
                ...
                <h3 className="text-[#D4AF37] font-bold tracking-[0.3em] text-xs uppercase font-sans-modern">
                    Al-Hikmah Academy
                </h3>
            </div>
            ...
            {/* Title */}
            <div>
                <h1 className="font-serif text-3xl text-[#333] mb-1">Sertifikat Kelulusan</h1>
                <div className="h-1 w-20 bg-[#D4AF37] mx-auto rounded-full"></div>
            </div>

            {/* User Name */}
            <div className="w-full">
                <p className="text-[#8A8A8A] text-xs font-sans-modern italic mb-2">Diberikan kepada:</p>
            ...
            {/* Course Info */}
            <div className="w-full">
                <p className="text-[#8A8A8A] text-xs font-sans-modern italic mb-1">Telah menuntaskan materi:</p>
            ...
            <div className="mt-8 flex justify-between items-end w-full border-t border-[#E5E5E5] pt-4">
                ...
                <div className="text-right">
                    ...
                    <p className="text-[10px] text-[#8A8A8A]">Al-Hikmah Platform</p>
                </div>
            </div>
        </div>
